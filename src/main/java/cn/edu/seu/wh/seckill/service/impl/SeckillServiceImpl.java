package cn.edu.seu.wh.seckill.service.impl;
...
import cn.edu.seu.wh.seckill.mapper.SeckillOrderMapper;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    * @Description: *
     ...
     *      
    * @Param: [seckillId, money, userPhone, md5]
    * @return: cn.edu.seu.wh.seckill.dto.SeckillExcution
    * @thorws:
    * @Author: Mr.Wang
    * @Date: 2019/11/13
    */
    @Override
    @Transactional
    public SeckillExcution excuteSeckill(long seckillId, BigDecimal money, long userPhone, String md5) throws SeckillException, RepeatKillException, SeckillCloseException {
        ...
        try{
            ...
            if(insertCount<=0){
                ...
                if (updateCount <= 0) {
                    ...
                    return new SeckillExcution(seckillId, SeckillStateEnum.SUCCESS, seckillOrder);
                }
            }
